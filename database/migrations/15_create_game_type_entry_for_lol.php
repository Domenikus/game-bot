...
return new class extends Migration
{
    ...
    {
        $game = Game::withInactive()->where('name', Game::GAME_NAME_LEAGUE_OF_LEGENDS)->firstOrFail();
    ...
    {
        $game = Game::withInactive()->with('types')->where('name', Game::GAME_NAME_LEAGUE_OF_LEGENDS)->firstOrFail();
        $game->types()->sync([]);
    }
};
